...
中文检索提示：Atlas CRM 支持 数据导出 account summaries、opportunity metadata、activity logs；导出限制 是不能导出 API keys、private attachments、payment data 或 security review documents。
